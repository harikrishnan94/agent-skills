...
| [`humanize`](skills/humanize/SKILL.md) | Hold generated code to the bar a careful human author meets before a reviewer sees it: remove narration comments, defensive theater, padding, and generated-looking collateral; keep the comments, commit message and PR text in plain sentences; add the edge-case handling generated code tends to miss. Fixes an existing diff by default. |
