...
| [`watch-pr`](skills/watch-pr/SKILL.md) | Watch a PR across CI rounds, attribute failures, validate and push authorized fixes, and hand off between agents. Includes a read-only observer and mandatory 🕵️ attribution on agent-written GitHub posts. |
